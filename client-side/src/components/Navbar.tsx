  ...
  return (
    <nav className="sticky top-0 z-30 w-full bg-forest-background text-forest-primary shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
        ...
        {/* Mobile menu button */}
        <button className="sm:hidden ml-auto mr-2" onClick={() => setMenuOpen(v => !v)} aria-label="Toggle menu">
      ...
      {menuOpen && (
        <div className="sm:hidden px-4 pb-3 flex flex-col gap-3 bg-forest-background border-t border-forest-soft">
          <Link href="/" className="hover:text-forest-light transition-colors py-2">Home</Link>
          <Link href="#" className="hover:text-forest-light transition-colors py-2">Become a Seller</Link>
          <Link href="#" className="hover:text-forest-light transition-colors py-2">Login</Link>
